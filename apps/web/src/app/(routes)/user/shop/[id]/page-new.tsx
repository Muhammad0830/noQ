...
export default function ShopDetailPage({ params }: ShopDetailPageProps) {
  ...
  const shop = {
    ...
    closeTime: "21:00",
    description:
      "Professional erkaklar sartaroshxonasi. Klassik va zamonaviy soch turmagi, soqol olish va parvarish. Tajribali ustalar va premium mahsulotlar.",
  };
  ...
  const services = [
    ...
    {
      id: 2,
      name: "Zamonaviy soch turmagi",
      duration: 45,
      price: 80000,
      description: "Trendi stillar va dizayn",
    },
    {
      id: 3,
      name: "Soqol olish",
      duration: 20,
      price: 30000,
      description: "Klassik ustara bilan soqol olish",
    },
    {
      id: 4,
      name: "Soqol parvarish",
      duration: 30,
      price: 40000,
      description: "Soqol shakllantirish va parvarish",
    },
    {
      id: 5,
      name: "Soch + Soqol",
      duration: 50,
      price: 70000,
      description: "To'liq xizmat paketi",
    },
    {
      id: 6,
      name: "Bola soch kesish",
      duration: 25,
      price: 40000,
      description: "12 yoshgacha bolalar uchun",
    },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "2 kun oldin",
      text: "Juda professional xizmat! Aziz usta zo'r!",
    },
    {
      id: 2,
      author: "Jahongir",
      rating: 5,
      date: "1 hafta oldin",
      text: "Eng yaxshi sartaroshxona shaharda!",
    },
    {
      id: 3,
      author: "Bobur",
      rating: 4,
      date: "2 hafta oldin",
      text: "Yaxshi xizmat, toza joy. Tavsiya qilaman",
    },
  ];
