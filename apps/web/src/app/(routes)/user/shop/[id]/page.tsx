...
export default function ShopProfile({
  ...
  const [heroImageHasError, setHeroImageHasError] = useState(false);
      ...
      <div className="max-w-3xl mx-auto px-4 mt-1">
        <div className="relative h-64 sm:h-80 bg-gray-300 overflow-hidden rounded-3xl">
          {shopLoading ? (
            ...
            <>
              {backgroundImage && !heroImageHasError ? (
                <img
                  src={backgroundImage}
                  alt={shopData.name}
                ...
                >
                  ...
                  <div className="flex items-center gap-3 ml-4 shrink-0">
                    ...
                    <Link
                      ...
                      className="px-4 sm:px-6 py-2 bg-teal-500 text-white text-xs sm:text-sm font-medium rounded-full hover:bg-teal-600 transition whitespace-nowrap"
                    >
                      {t("shops.book")}
                    </Link>
                  </div>
